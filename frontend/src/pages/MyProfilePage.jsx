...
export default function MyProfilePage() {
  ...
  return (
    <div className="page">
      ...
      {/* ── Profile Hero ──────────────────────────────────────────────────── */}
      <div style={{ background: '#ffffff', border: '1.5px solid rgba(200,150,10,0.35)', borderRadius: 20, overflow: 'hidden', marginBottom: 14, boxShadow: '0 4px 24px rgba(200,150,10,0.12), 0 1px 4px rgba(0,0,0,0.06)' }}>
        <div style={{ height: 80, background: 'linear-gradient(135deg,#1565c0 0%,#1877f2 40%,#4293f5 70%,#e8c84a 100%)', position: 'relative' }}>
        ...
        <div style={{ padding: '0 18px 20px', position: 'relative' }}>
          ...
          <div style={{ marginTop: 10 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap', marginBottom: 4 }}>
              <span style={{ fontWeight: 800, fontSize: 20, color: '#050505' }}>{data?.user?.name}</span>
